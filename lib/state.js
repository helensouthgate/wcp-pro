...
export const DEFAULT_STATE = {
  ...
  predictions: {},    // { [fixtureId]: structured prediction object or legacy string }
  ...
  lastPredictionCost: null, // { totalUsd, usage, ... } from lib/predictionCost.js
  predictionJob: null // { status, startedAt, error?, ... } — admin-visible job status
};
